"""
Simplified schemas for get-children endpoint.
...
class ChildNode(BaseModel):
    ...
    latest_status: Optional[str] = Field(None, description="Latest status (e.g., for SPOOL)")
...
class GetChildrenRequestV2(BaseModel):
    """
...
class GetChildrenResponseV2(BaseModel):
    """
